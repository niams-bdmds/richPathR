...
#' @example
#' enrichr_unique_terms(enrichr_df = enrichr_df, threshold_value = 2, threshold_value_type = 'minimum_combined_score')
#' enrichr_unique_terms(enrichr_df = enrichr_df, threshold_value = 0.3, threshold_value_type = 'minimum_p_value')

#' @export
enrichr_unique_terms <- function(enrichr_df, threshold_value = 5, threshold_value_type = "minimum_combined_score") {
  ...
  addDataFrame(enrichr_unique_terms, sheet,
